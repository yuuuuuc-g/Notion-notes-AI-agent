...
def add_memory(
    ...
    *,
    ...
    final_metadata["content"] = final_content[:3000]  # Metadata 里存多点，供 LLM 查看
...
def search_memory(query_text: str, n_results: int = 5, category_filter: str = None) -> Dict[str, Any]:
    """
    从向量数据库中检索相关记忆
